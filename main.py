...
def print_help(script_name: str):
    print(script_name, '[options]\n'
        ...
        '\t-o | --outputfile=[filepath]\t: spécifie le chemin vers le fichier CSV de sortie pour ProjeQtOr')
...
if __name__ == '__main__':
    input_file, output_file = parse_opt(sys.argv[0], sys.argv[1:])

    try:
        # instanciation couche [ui]
        ui = Ui()
        # exécution couche [console]
        ui.run(input_file, output_file)
